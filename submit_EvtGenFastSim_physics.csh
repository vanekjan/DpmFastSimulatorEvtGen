...
#usage example: ./submit_EvtGenFastSim_physics.csh 0 40 0
...
star-submit-template -template submitToyMcEvtGen_physics.xml -entities productionId=${prodId},nEvents=${nEvents},centLow=${centLow},centHigh=${centHigh},pTspectrum=${pTspectrum}
