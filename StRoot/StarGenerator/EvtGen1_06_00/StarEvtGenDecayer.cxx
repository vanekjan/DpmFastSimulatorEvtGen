...
{
    if(mDebug) LOG_INFO << "Decay pdgid=" << pdgId << endm; //print this olnly for debug
...
{
    if(mDebug) LOG_INFO << "Decay EvtGen Particle=" << EvtGenParticleName << endm; //print this only for debug
