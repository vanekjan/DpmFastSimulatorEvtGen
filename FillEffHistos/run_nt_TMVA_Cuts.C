...
void run_nt_TMVA_Cuts(TString infile = "/star/u/vanekjan/pwg/vanekjan/myDpmEvtGenFastSim/myOutput/2023-07-01_08-24/merge/output.root", 
                      ...
                      const int pTspectrum = 0, const int ReadMode = 1, const int daugter_pT_cut = 0) 
  {
  ...
  n.Set_ReadMode(ReadMode);//ReadMode = 0 - pre-cuts, ReadMode = 1 - TMVA analysis cuts, ReadMode = 2 - TMVA loose cuts, ReadMode = 3 - TMVA tight cuts, ReadMode = 4 - old topo. cuts
  n.Set_pTspectrum(pTspectrum);// pTspectrum = 0 - flat input pT spectrum (use weights), 1 - Levy input spectrum (do not use weights - already realistic pT shape)
